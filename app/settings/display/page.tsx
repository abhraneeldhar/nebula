...
export default function Displaysettings() {
    ...
    const PreviewCard = ({ theme }: { theme: {
        ...
        if (resolvedTheme == theme.name) {
            cardClassname = `${styles.previewCard} ${styles.selectedCard}`
        }
        else {
            cardClassname = `${styles.previewCard}`
        }
        return (
            <div onClick={()=>{setTheme(theme.name)}} style={{ backgroundColor: theme.color1 }} className={cardClassname}>
